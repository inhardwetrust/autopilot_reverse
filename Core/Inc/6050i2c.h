...
void SendDataSP2 (void);
void SendDataSP3 (float roll_angle, float a_roll);
void SendFloatSP (float indata);
...
#define R2DEG	180/3.14159
#define sqr(x) ((x)*(x))

/// DLPF_CFG - low path filter
...
//void IntToSerialPortLN(UART_HandleTypeDef *UART_ptr, int16_t Number);



#endif /* INC_6050I2C_H_ */
